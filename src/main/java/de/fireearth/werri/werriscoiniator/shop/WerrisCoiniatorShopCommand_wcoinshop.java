            ...
            case 2: {
                ...
                if (split[0].equalsIgnoreCase("list")) {
                    ...
                    try {
                        ...
                        if (!werrisCoiniatorEconomy.has(player.getName(), e)) {
                        ...
                        werrisCoiniatorEconomy.withdrawPlayer(player.getName(), plugin.getShopName(), e);
                    ...
                    try {
                        ...
                        werrisCoiniatorEconomy.withdrawPlayer(player.getName(), plugin.getShopName(), e);
                        vaultEconomy.depositPlayer(player.getName(), f);
                    ...
                    try {
                        ...
                        werrisCoiniatorEconomy.depositPlayer(plugin.getShopName(), player.getName(), e);
                    ...
                    try {
                        ...
                        Double f = werrisCoiniatorShopItems.getKeyItemsMap().get(e);
                        vaultEconomy.withdrawPlayer(player.getName(), f);
                        werrisCoiniatorEconomy.depositPlayer(plugin.getShopName(), player.getName(), e);
